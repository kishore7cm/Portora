#!/usr/bin/env python3
"""
Fetch real market data using Alpaca API for stocks and Twelve Data API for crypto
"""
...
def fetch_real_market_data():
    """Fetch real market data for the past week"""
    print("🚀 Fetching REAL market data using Alpaca (stocks) and Twelve Data (crypto) APIs...")
    print("⚠️  Note: This requires valid API keys. Using demo keys will return limited data.")
