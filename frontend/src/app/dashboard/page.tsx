...
import { TrendingUp, TrendingDown, DollarSign, BarChart3, Filter, SortAsc, SortDesc, Bot, Target, Bell, Users, Sun, Moon } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white">EaseLi Portfolio Advisor</h1>
            </div>
